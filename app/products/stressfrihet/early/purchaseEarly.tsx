	...
	return (
		...
		>
			...
			<div className="bg-background p-16 rounded-2xl flex flex-col gap-4 max-w-screen-md items-center text-left">
				...
				<p>De 5 första som anmäler sig innan den 1 Juni kl 22:00 får Early Bird <span className="text-red-600 font-bold">rabatt på 2000 kr.</span></p>

				<Image
					className="rounded-xl"
					width="400"
					height="150"
					src="https://automatehero.io/api/path/UkJ1Tm85TFdRd1RX/gif"
					alt="countdown"
				/>
				<h3>När timern gått ner kommer priset höjas</h3>


				<h3 className="font-bold mt-10 text-xl md:text-2xl "> Early Bird pris: <span className="text-red-600">7970 kr</span></h3>
				<Button
					variant="secondary"
					type="link"
